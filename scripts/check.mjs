...
await walk('src');
await walk('dist/src');
for (const p of ['public/index.html','public/styles/main.css','public/assets/favicon.svg','dist/index.html','dist/styles/main.css','dist/assets/favicon.svg']) await readFile(p);
